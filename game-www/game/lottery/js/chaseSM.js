var LotteryChaseSM = function () {
    ...
    var initContent = function (content) {
        ...
        var getMultipleMoney = function (multiple) {
            var total = 0;
            for (var i = 0; i < order_list2.length; i++) {
                var v = order_list2[i];
        ...
        var initAdvanced = function () {
            ...
            var doGenerate = function () {
                ...
                var bonus = getBonus(order_list2[0]);
                if (bonus == 0) {
                    AlertUtils.alert({
                        icon: 'info',
                        content: '该玩法不支持利润率追号'
