$(document).ready(function () {
    ...
    var doSearch = function () {
        initReqData();
        GamesimulationCtrl.request('SEARCH_PLAYRECORD', {
            data: reqData,
            beforeSend: function () {
            ...
            $.each(resData.list, function (i, v) {
                ...
                var tpl =
                    '<tr>\
                        ...
                        <td class="text-center">' + moment(v.startTime).format('YYYY-MM-DD HH:mm:ss') + '</td>\
                        <td class="text-center">' + moment(v.endTime).format('YYYY-MM-DD HH:mm:ss') + '</td>\
                    </tr>';
                var $thisRow = $(tpl);
