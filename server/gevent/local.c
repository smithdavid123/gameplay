...
static int __Pyx_modinit_type_import_code(void) {
  ...
  __pyx_ptype_6gevent_9_greenlet_Greenlet = __Pyx_ImportType(__pyx_t_3, "gevent._greenlet", "Greenlet", sizeof(struct __pyx_obj_6gevent_9_greenlet_Greenlet), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_6gevent_9_greenlet_Greenlet) __PYX_ERR(2, 86, __pyx_L1_error)
  __pyx_vtabptr_6gevent_9_greenlet_Greenlet = (struct __pyx_vtabstruct_6gevent_9_greenlet_Greenlet*)__Pyx_GetVtable(__pyx_ptype_6gevent_9_greenlet_Greenlet->tp_dict); if (unlikely(!__pyx_vtabptr_6gevent_9_greenlet_Greenlet)) __PYX_ERR(2, 86, __pyx_L1_error)
