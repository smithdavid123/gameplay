...
PK10Method['qianerzxfs'] = {
    ...
    example: '投注方案：第一位选择01 第二位选择02，开奖号码第一位01，第二位02即为中奖。',
    help: '从第一位、第二位中至少格选一个号码进行投注，购买号码与开奖号码前二位号码相同且顺序不变，即为中奖。',
    select: {
        layout: [{
            title: '第一位',
            balls: ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10'],
...
PK10Method['qianerzxds'] = {
    ...
    example: '投注方案：手动输入01 02，开奖号码第一位01，第二位02即为中奖。',
    help: '手动输入两个号码组成一注进行投注，购买号码与开奖号码前二位号码相同且顺序不变，即为中奖。',
    textarea: {}
};
// 前三
PK10Method['qiansanzxfs'] = {
    ...
    realname: '[前三_复式]',
    tips: '从第一位、第二位、第三位中至少各选择1个号码。',
    example: '投注方案：第一位选择01 第二位选择02，第三位选择03，开奖号码第一位01，第二位02，第三位选择03，即为中奖。',
...
PK10Method['qiansanzxds'] = {
    ...
    example: '投注方案：手动输入01 02 03，开奖号码第一位01，第二位02，第三位03即为中奖。',
    help: '选号与开奖号码中第一位、第二位、第三位一致即中奖。',
    textarea: {}
};
// 定位胆
...
var PK10Layout = [{
    ...
    rows: [[{
        title: '前二',
        columns: ['qianerzxfs', 'qianerzxds']
    }]]
}, {
    title: '前三',
    rows: [[{
        title: '前三',
        columns: ['qiansanzxfs', 'qiansanzxds']
    }]]
}, {
    title: '定位胆',
    rows: [[{
    ...
    rows: [[{
        title: '大小',
        columns: ['dxd1', 'dxd2', 'dxd3']
    }]]
}, {
    title: '单双',
    rows: [[{
        title: '单双',
        columns: ['dsd1', 'dsd2', 'dsd3']
    }]]
}];
