  ...
  export default {
    ...
    data() {
      return {
        ...
        keyList: 'DRAWINF_LIMIT_PERCENT,WITHDRAW_TIME,WITHDRAW_MAX_COUNT,WITHDRAW_FREE_COUNT,WITHDRAW_MAX_AMOUNT_DAILY,WITHDRAW_MAX_AMOUNT_UNIT,WITHDRAW_MIN_AMOUNT_UNIT,WITHDRAW_MAX_FREE',
        tableColumns: [{
          type: 'selection',
          width: '55',
          align: 'center'
    ...
    methods: {
      ...
      async getKeyList() {
        try {
          const {
          data
        } = await this.$api.getSystemValueList({index: 1});
